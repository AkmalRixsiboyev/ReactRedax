            ...
            <Modal isOpen={isOpen} toggle={toggleModal} >
                ...
                <ModalBody>
                    <form id="form" onSubmit={addUsers} action="">
                        ...
                        <input className="form-control my-2 border border-primary text-dark" placeholder="bonus" type="text"/>
                    </form>
                </ModalBody>
                <ModalFooter>
...
export default connect((state)=> ({isOpen: state.DarajaReduser.active,
    stateUser:state.DarajaReduser.darajalar}),{Allusers}) (DarajaModal)
