...
export function XodimReduser (state={
    xodimlar:[
        {id: 1, name: 'Akmal', lastname: 'Rixsiboyev', telefon: 909463334, lavozim: 'Menejer', daraja:'Senior' },
        {id: 2, name: 'Gayrat', lastname: 'Rixsiboyev', telefon: 909463334, lavozim: 'Dispatcher', daraja: 'Middle' },
        {id: 3, name: 'Iroda', lastname: 'Rixsiboyev', telefon: 909463334, lavozim: 'bekorchi', daraja:'Junir' },
    ],
    active: false,
    active1: false
}, action){
...
export function LavozimReduser(state={
    lavozimlar:[
...
export function DarajaReduser(state={
    darajalar:[
